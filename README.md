**Project Description**:This Selenium automation project performs an end-to-end flow on Flipkart by searching for “Bluetooth Speakers,” applying filters, sorting results, and opening the first product.
It checks whether the Available Offers section exists and prints the number of offers.
If the product is available, it adds it to the cart and captures cart_result.png; otherwise, it captures result.png.
